...
@keyframes heroFloat{0%,100%{transform:translateY(0px) rotate(0deg) scale(1)}50%{transform:translateY(-18px) rotate(-1deg) scale(1.02)}}
@keyframes cardFloat{0%,100%{transform:translateY(0px) scale(1)}50%{transform:translateY(-10px) scale(1.015)}}
