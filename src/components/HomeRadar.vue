...
@keyframes heroFloat{0%,100%{transform:translateY(0px) rotate(0deg) scale(1)}50%{transform:translateY(-26px) rotate(-1.8deg) scale(1.04)}}
@keyframes cardFloat{0%,100%{transform:translateY(0px) scale(1)}50%{transform:translateY(-16px) scale(1.025)}}
