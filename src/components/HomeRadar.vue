  ...
  <main class="home-stage">
    ...
    <section :key="`hero-${currentMonth}`" class="release-hero" :style="{ '--hero-accent': getTypeAccent(featuredItem) }">
      ...
      >
        ...
        <img :src="featuredImage" :alt="featuredName" loading="eager" fetchpriority="high" decoding="async" onerror="this.style.display='none'" />
          ...
          <div class="release-grid">
            ...
            >
              ...
              <div class="release-card__image">
                <img :src="getCharacterImage(item.bannerImage || getCharacter(item.id).imageURL)" :alt="item.overrideName || getCharacter(item.id).name" loading="lazy" fetchpriority="low" decoding="async" onerror="this.style.display='none'" />
              </div>
