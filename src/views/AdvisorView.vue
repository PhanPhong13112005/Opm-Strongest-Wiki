...
<template>
  <main class="px-4 py-10 sm:px-7 lg:py-14">
    <div class="mx-auto max-w-6xl">
      <header class="advisor-head"><div><p>AI DATA AUXILIARY / THỬ NGHIỆM</p><h1>Trợ lý dữ liệu</h1><span>Truy vấn nhân vật và sự kiện từ cơ sở dữ liệu Wiki.</span></div><div class="advisor-status"><i />TRẠNG THÁI<br><b>THỬ NGHIỆM</b></div></header>
